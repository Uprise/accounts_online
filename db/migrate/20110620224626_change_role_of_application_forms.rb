class ChangeRoleOfApplicationForms < ActiveRecord::Migration
  def self.up
    add_column    :application_forms, :entity_id, :integer
    ...
    remove_column :application_forms, :gst_number_1
  ...
  def self.down
    remove_column :application_forms, :entity_id
    ...
    add_column :application_forms, :gst_number_1, :string
